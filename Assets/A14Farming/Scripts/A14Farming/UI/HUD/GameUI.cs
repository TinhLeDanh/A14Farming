...
namespace A14Farming.UI.HUD
{
    ...
    public class GameUI : Singleton<GameUI>
    {
        ...
        /// </summary>
        BuildingPlacementGhost m_CurrentTower;
        ...
        /// </summary>
        public Building currentSelectedTower { get; private set; }
        ...
        /// </exception>
        public void SetToDragMode([NotNull] Building towerToBuild)
        {
        ...
        /// </exception>
        public void SetToBuildMode([NotNull] Building towerToBuild)
        {
            if (state != State.Normal)
            {
        ...
        /// </exception>
        public void SelectTower(Building tower)
        {
            if (state != State.Normal)
            {
        ...
        public void PlaceTower()
        {
            ...
            Building createdTower = Instantiate(m_CurrentTower.controller);
        ...
        public void TrySelectTower(PointerInfo info)
        {
            ...
            var controller = output.collider.GetComponent<Building>();
            if (controller != null)
            {
        ...
        protected void PlaceGhost(UIPointer pointer)
        {
            ...
            if (m_CurrentArea != null)
            {
                ...
                {
                    // Place the ghost
                    Building controller = m_CurrentTower.controller;

                    Building createdTower = Instantiate(controller);
                    //createdTower.Initialize(m_CurrentArea, m_GridPosition);
        ...
        protected virtual void OnCurrencyChanged()
        {
            ...
            TowerFitStatus fits = m_CurrentArea.Fits(m_GridPosition, m_CurrentTower.controller.dimensions);
            bool valid = fits == TowerFitStatus.Fits;
            m_CurrentTower.Move(m_CurrentArea.GridToWorld(m_GridPosition, m_CurrentTower.controller.dimensions),
                                m_CurrentArea.transform.rotation,
                                valid);
        ...
        /// </summary>
        protected void OnTowerDied(Building targetable)
        {
            DeselectTower();
        }
        ...
        /// </exception>
        void SetUpGhostTower([NotNull] Building towerToBuild)
        {
